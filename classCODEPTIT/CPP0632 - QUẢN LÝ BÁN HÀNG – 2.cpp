...
istream& operator >> (istream& in, HoaDon &a)
{
	...
	a.thtien=MH[a.mah].ban*a.sl;
	a.loi=a.thtien-a.sl*MH[a.mah].mua;
	++ttd;
	return in;
}
ostream& operator << (ostream& out, HoaDon a)
{
	cout<<a.mad<<" "<<KH[a.mak].ten<<" "<<KH[a.mak].dc<<" "<<MH[a.mah].ten<<" "<<a.sl<<" "<<a.thtien<<" "<<a.loi<<endl;
	return out;
}
